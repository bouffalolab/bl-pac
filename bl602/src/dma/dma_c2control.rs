...
pub type SBSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C2CONTROL_SPEC, u8, u8, 3, O>;
#[doc = "Field `DBSize` reader - "]
pub type DBSIZE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DBSize` writer - "]
pub type DBSIZE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_C2CONTROL_SPEC, u8, u8, 3, O>;
...
#[doc = "`reset()` method sets DMA_C2Control to value 0x0c48_9000"]
