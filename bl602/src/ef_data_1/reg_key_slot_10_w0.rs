...
pub struct W(crate::W<REG_KEY_SLOT_10_W0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<REG_KEY_SLOT_10_W0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<REG_KEY_SLOT_10_W0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<REG_KEY_SLOT_10_W0_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
impl crate::Writable for REG_KEY_SLOT_10_W0_SPEC {
    type Writer = W;
