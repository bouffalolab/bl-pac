...
pub type RX_IQ_PHASE_COMP_GC1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `rx_iq_phase_comp_gc1` writer - "]
pub type RX_IQ_PHASE_COMP_GC1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RXIQ_CTRL_HW2_SPEC, u16, u16, 10, O>;
#[doc = "Field `rx_iq_gain_comp_gc1` reader - "]
pub type RX_IQ_GAIN_COMP_GC1_R = crate::FieldReader<u16, u16>;
#[doc = "Field `rx_iq_gain_comp_gc1` writer - "]
pub type RX_IQ_GAIN_COMP_GC1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RXIQ_CTRL_HW2_SPEC, u16, u16, 11, O>;
impl R {
    #[doc = "Bits 0:9"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_iq_phase_comp_gc1(&mut self) -> RX_IQ_PHASE_COMP_GC1_W<0> {
        RX_IQ_PHASE_COMP_GC1_W::new(self)
    }
    #[doc = "Bits 16:26"]
    #[inline(always)]
    #[must_use]
    pub fn rx_iq_gain_comp_gc1(&mut self) -> RX_IQ_GAIN_COMP_GC1_W<16> {
        RX_IQ_GAIN_COMP_GC1_W::new(self)
    }
