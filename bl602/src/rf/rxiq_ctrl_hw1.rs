...
impl From<crate::R<RXIQ_CTRL_HW1_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<RXIQ_CTRL_HW1_SPEC>> for W {
    #[inline(always)]
...
pub type RX_IQ_PHASE_COMP_GC0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `rx_iq_phase_comp_gc0` writer - "]
pub type RX_IQ_PHASE_COMP_GC0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RXIQ_CTRL_HW1_SPEC, u16, u16, 10, O>;
#[doc = "Field `rx_iq_gain_comp_gc0` reader - "]
pub type RX_IQ_GAIN_COMP_GC0_R = crate::FieldReader<u16, u16>;
#[doc = "Field `rx_iq_gain_comp_gc0` writer - "]
pub type RX_IQ_GAIN_COMP_GC0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RXIQ_CTRL_HW1_SPEC, u16, u16, 11, O>;
impl R {
    #[doc = "Bits 0:9"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_iq_phase_comp_gc0(&mut self) -> RX_IQ_PHASE_COMP_GC0_W<0> {
        RX_IQ_PHASE_COMP_GC0_W::new(self)
    }
    #[doc = "Bits 16:26"]
    #[inline(always)]
    #[must_use]
    pub fn rx_iq_gain_comp_gc0(&mut self) -> RX_IQ_GAIN_COMP_GC0_W<16> {
        RX_IQ_GAIN_COMP_GC0_W::new(self)
    }
