...
impl From<crate::R<LO_CAL_CTRL_HW8_SPEC>> for R {
    #[inline(always)]
...
impl From<crate::W<LO_CAL_CTRL_HW8_SPEC>> for W {
    #[inline(always)]
...
pub type LO_VCO_IDAC_CW_2460_R = crate::FieldReader<u8, u8>;
#[doc = "Field `lo_vco_idac_cw_2460` writer - "]
pub type LO_VCO_IDAC_CW_2460_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CAL_CTRL_HW8_SPEC, u8, u8, 5, O>;
#[doc = "Field `lo_vco_freq_cw_2460` reader - "]
pub type LO_VCO_FREQ_CW_2460_R = crate::FieldReader<u8, u8>;
#[doc = "Field `lo_vco_freq_cw_2460` writer - "]
pub type LO_VCO_FREQ_CW_2460_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CAL_CTRL_HW8_SPEC, u8, u8, 8, O>;
#[doc = "Field `lo_vco_idac_cw_2464` reader - "]
pub type LO_VCO_IDAC_CW_2464_R = crate::FieldReader<u8, u8>;
#[doc = "Field `lo_vco_idac_cw_2464` writer - "]
pub type LO_VCO_IDAC_CW_2464_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CAL_CTRL_HW8_SPEC, u8, u8, 5, O>;
#[doc = "Field `lo_vco_freq_cw_2464` reader - "]
pub type LO_VCO_FREQ_CW_2464_R = crate::FieldReader<u8, u8>;
#[doc = "Field `lo_vco_freq_cw_2464` writer - "]
pub type LO_VCO_FREQ_CW_2464_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CAL_CTRL_HW8_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lo_vco_idac_cw_2460(&mut self) -> LO_VCO_IDAC_CW_2460_W<0> {
        LO_VCO_IDAC_CW_2460_W::new(self)
    }
    #[doc = "Bits 8:15"]
    #[inline(always)]
    #[must_use]
    pub fn lo_vco_freq_cw_2460(&mut self) -> LO_VCO_FREQ_CW_2460_W<8> {
        LO_VCO_FREQ_CW_2460_W::new(self)
    }
    #[doc = "Bits 16:20"]
    #[inline(always)]
    #[must_use]
    pub fn lo_vco_idac_cw_2464(&mut self) -> LO_VCO_IDAC_CW_2464_W<16> {
        LO_VCO_IDAC_CW_2464_W::new(self)
    }
    #[doc = "Bits 24:31"]
    #[inline(always)]
    #[must_use]
    pub fn lo_vco_freq_cw_2464(&mut self) -> LO_VCO_FREQ_CW_2464_W<24> {
        LO_VCO_FREQ_CW_2464_W::new(self)
    }
