...
pub type RF_SRAM_ADC_ADDR_END_R = crate::FieldReader<u16, u16>;
#[doc = "Field `rf_sram_adc_addr_end` writer - "]
pub type RF_SRAM_ADC_ADDR_END_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RF_SRAM_CTRL2_SPEC, u16, u16, 16, O>;
#[doc = "Field `rf_sram_adc_addr_start` reader - "]
pub type RF_SRAM_ADC_ADDR_START_R = crate::FieldReader<u16, u16>;
#[doc = "Field `rf_sram_adc_addr_start` writer - "]
pub type RF_SRAM_ADC_ADDR_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RF_SRAM_CTRL2_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rf_sram_adc_addr_end(&mut self) -> RF_SRAM_ADC_ADDR_END_W<0> {
        RF_SRAM_ADC_ADDR_END_W::new(self)
    }
    #[doc = "Bits 16:31"]
    #[inline(always)]
    #[must_use]
    pub fn rf_sram_adc_addr_start(&mut self) -> RF_SRAM_ADC_ADDR_START_W<16> {
        RF_SRAM_ADC_ADDR_START_W::new(self)
    }
