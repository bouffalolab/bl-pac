...
pub type LO_VCO_IDAC_CW_2412_R = crate::FieldReader<u8, u8>;
#[doc = "Field `lo_vco_idac_cw_2412` writer - "]
pub type LO_VCO_IDAC_CW_2412_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CAL_CTRL_HW2_SPEC, u8, u8, 5, O>;
#[doc = "Field `lo_vco_freq_cw_2412` reader - "]
pub type LO_VCO_FREQ_CW_2412_R = crate::FieldReader<u8, u8>;
#[doc = "Field `lo_vco_freq_cw_2412` writer - "]
pub type LO_VCO_FREQ_CW_2412_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CAL_CTRL_HW2_SPEC, u8, u8, 8, O>;
#[doc = "Field `lo_vco_idac_cw_2416` reader - "]
pub type LO_VCO_IDAC_CW_2416_R = crate::FieldReader<u8, u8>;
#[doc = "Field `lo_vco_idac_cw_2416` writer - "]
pub type LO_VCO_IDAC_CW_2416_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CAL_CTRL_HW2_SPEC, u8, u8, 5, O>;
#[doc = "Field `lo_vco_freq_cw_2416` reader - "]
pub type LO_VCO_FREQ_CW_2416_R = crate::FieldReader<u8, u8>;
#[doc = "Field `lo_vco_freq_cw_2416` writer - "]
pub type LO_VCO_FREQ_CW_2416_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CAL_CTRL_HW2_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lo_vco_idac_cw_2412(&mut self) -> LO_VCO_IDAC_CW_2412_W<0> {
        LO_VCO_IDAC_CW_2412_W::new(self)
    }
    #[doc = "Bits 8:15"]
    #[inline(always)]
    #[must_use]
    pub fn lo_vco_freq_cw_2412(&mut self) -> LO_VCO_FREQ_CW_2412_W<8> {
        LO_VCO_FREQ_CW_2412_W::new(self)
    }
    #[doc = "Bits 16:20"]
    #[inline(always)]
    #[must_use]
    pub fn lo_vco_idac_cw_2416(&mut self) -> LO_VCO_IDAC_CW_2416_W<16> {
        LO_VCO_IDAC_CW_2416_W::new(self)
    }
    #[doc = "Bits 24:31"]
    #[inline(always)]
    #[must_use]
    pub fn lo_vco_freq_cw_2416(&mut self) -> LO_VCO_FREQ_CW_2416_W<24> {
        LO_VCO_FREQ_CW_2416_W::new(self)
    }
