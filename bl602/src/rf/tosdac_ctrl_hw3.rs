...
pub type TBB_TOSDAC_I_GC4_R = crate::FieldReader<u8, u8>;
#[doc = "Field `tbb_tosdac_i_gc4` writer - "]
pub type TBB_TOSDAC_I_GC4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TOSDAC_CTRL_HW3_SPEC, u8, u8, 6, O>;
#[doc = "Field `tbb_tosdac_q_gc4` reader - "]
pub type TBB_TOSDAC_Q_GC4_R = crate::FieldReader<u8, u8>;
#[doc = "Field `tbb_tosdac_q_gc4` writer - "]
pub type TBB_TOSDAC_Q_GC4_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TOSDAC_CTRL_HW3_SPEC, u8, u8, 6, O>;
#[doc = "Field `tbb_tosdac_i_gc5` reader - "]
pub type TBB_TOSDAC_I_GC5_R = crate::FieldReader<u8, u8>;
#[doc = "Field `tbb_tosdac_i_gc5` writer - "]
pub type TBB_TOSDAC_I_GC5_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TOSDAC_CTRL_HW3_SPEC, u8, u8, 6, O>;
#[doc = "Field `tbb_tosdac_q_gc5` reader - "]
pub type TBB_TOSDAC_Q_GC5_R = crate::FieldReader<u8, u8>;
#[doc = "Field `tbb_tosdac_q_gc5` writer - "]
pub type TBB_TOSDAC_Q_GC5_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TOSDAC_CTRL_HW3_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tbb_tosdac_i_gc4(&mut self) -> TBB_TOSDAC_I_GC4_W<0> {
        TBB_TOSDAC_I_GC4_W::new(self)
    }
    #[doc = "Bits 8:13"]
    #[inline(always)]
    #[must_use]
    pub fn tbb_tosdac_q_gc4(&mut self) -> TBB_TOSDAC_Q_GC4_W<8> {
        TBB_TOSDAC_Q_GC4_W::new(self)
    }
    #[doc = "Bits 16:21"]
    #[inline(always)]
    #[must_use]
    pub fn tbb_tosdac_i_gc5(&mut self) -> TBB_TOSDAC_I_GC5_W<16> {
        TBB_TOSDAC_I_GC5_W::new(self)
    }
    #[doc = "Bits 24:29"]
    #[inline(always)]
    #[must_use]
    pub fn tbb_tosdac_q_gc5(&mut self) -> TBB_TOSDAC_Q_GC5_W<24> {
        TBB_TOSDAC_Q_GC5_W::new(self)
    }
