...
pub type LO_VCO_IDAC_CW_2468_R = crate::FieldReader<u8, u8>;
#[doc = "Field `lo_vco_idac_cw_2468` writer - "]
pub type LO_VCO_IDAC_CW_2468_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CAL_CTRL_HW9_SPEC, u8, u8, 5, O>;
#[doc = "Field `lo_vco_freq_cw_2468` reader - "]
pub type LO_VCO_FREQ_CW_2468_R = crate::FieldReader<u8, u8>;
#[doc = "Field `lo_vco_freq_cw_2468` writer - "]
pub type LO_VCO_FREQ_CW_2468_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CAL_CTRL_HW9_SPEC, u8, u8, 8, O>;
#[doc = "Field `lo_vco_idac_cw_2472` reader - "]
pub type LO_VCO_IDAC_CW_2472_R = crate::FieldReader<u8, u8>;
#[doc = "Field `lo_vco_idac_cw_2472` writer - "]
pub type LO_VCO_IDAC_CW_2472_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CAL_CTRL_HW9_SPEC, u8, u8, 5, O>;
#[doc = "Field `lo_vco_freq_cw_2472` reader - "]
pub type LO_VCO_FREQ_CW_2472_R = crate::FieldReader<u8, u8>;
#[doc = "Field `lo_vco_freq_cw_2472` writer - "]
pub type LO_VCO_FREQ_CW_2472_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LO_CAL_CTRL_HW9_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lo_vco_idac_cw_2468(&mut self) -> LO_VCO_IDAC_CW_2468_W<0> {
        LO_VCO_IDAC_CW_2468_W::new(self)
    }
    #[doc = "Bits 8:15"]
    #[inline(always)]
    #[must_use]
    pub fn lo_vco_freq_cw_2468(&mut self) -> LO_VCO_FREQ_CW_2468_W<8> {
        LO_VCO_FREQ_CW_2468_W::new(self)
    }
    #[doc = "Bits 16:20"]
    #[inline(always)]
    #[must_use]
    pub fn lo_vco_idac_cw_2472(&mut self) -> LO_VCO_IDAC_CW_2472_W<16> {
        LO_VCO_IDAC_CW_2472_W::new(self)
    }
    #[doc = "Bits 24:31"]
    #[inline(always)]
    #[must_use]
    pub fn lo_vco_freq_cw_2472(&mut self) -> LO_VCO_FREQ_CW_2472_W<24> {
        LO_VCO_FREQ_CW_2472_W::new(self)
    }
