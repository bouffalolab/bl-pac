...
pub struct R(crate::R<PSRAM_CONFIG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PSRAM_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PSRAM_CONFIG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PSRAM_CONFIG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `psram_config` writer"]
pub struct W(crate::W<PSRAM_CONFIG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PSRAM_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PSRAM_CONFIG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PSRAM_CONFIG_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
