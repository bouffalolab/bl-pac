...
pub struct R(crate::R<WIFI_PLL_CONFIG_10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<WIFI_PLL_CONFIG_10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<WIFI_PLL_CONFIG_10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<WIFI_PLL_CONFIG_10_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `wifi_pll_config_10` writer"]
pub struct W(crate::W<WIFI_PLL_CONFIG_10_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<WIFI_PLL_CONFIG_10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<WIFI_PLL_CONFIG_10_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<WIFI_PLL_CONFIG_10_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
