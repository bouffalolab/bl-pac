...
pub struct R(crate::R<SELF_TEST_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SELF_TEST_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SELF_TEST_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SELF_TEST_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `self_test_0` writer"]
pub struct W(crate::W<SELF_TEST_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SELF_TEST_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SELF_TEST_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SELF_TEST_0_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
