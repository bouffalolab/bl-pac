...
pub struct R(crate::R<SDH_CONFIG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SDH_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SDH_CONFIG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SDH_CONFIG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `sdh_config` writer"]
pub struct W(crate::W<SDH_CONFIG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SDH_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SDH_CONFIG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SDH_CONFIG_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
