...
pub struct R(crate::R<EMAC_CONFIG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EMAC_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EMAC_CONFIG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EMAC_CONFIG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `emac_config` writer"]
pub struct W(crate::W<EMAC_CONFIG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EMAC_CONFIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EMAC_CONFIG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EMAC_CONFIG_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
