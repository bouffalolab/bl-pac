...
pub struct R(crate::R<FINITE_IMPULSE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FINITE_IMPULSE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FINITE_IMPULSE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FINITE_IMPULSE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `finite_impulse` writer"]
pub struct W(crate::W<FINITE_IMPULSE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FINITE_IMPULSE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FINITE_IMPULSE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FINITE_IMPULSE_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
