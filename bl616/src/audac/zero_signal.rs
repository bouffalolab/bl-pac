...
pub struct R(crate::R<ZERO_SIGNAL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ZERO_SIGNAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ZERO_SIGNAL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ZERO_SIGNAL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `zero_signal` writer"]
pub struct W(crate::W<ZERO_SIGNAL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ZERO_SIGNAL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ZERO_SIGNAL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ZERO_SIGNAL_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
